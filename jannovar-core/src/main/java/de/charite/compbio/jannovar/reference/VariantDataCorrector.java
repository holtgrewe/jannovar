 ...
 *
 * This is used in the constructor {@link SmallGenomeVariant} so there is no need for using this class directly when the
 * change is converted into a {@link SmallGenomeVariant} before processing. This class has package-visibility only because its
 * members are visible to the outside. Rather construct a {@link SmallGenomeVariant} and use this immutable class.
 *
