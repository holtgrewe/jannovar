 ...
 */
public class JannovarAnnotateVCFSymbolicInversionTest {
	...
	public void testOnSymbolicInversionAllele() throws IOException, URISyntaxException, CommandLineParsingException,
		...
		File f = new File(outFolder.getAbsolutePath() + File.separator + "symbolic_inv.jv.vcf");
		Assert.assertTrue(f.exists());

		final File expectedFile = new File(this.getClass().getResource("/symbolic_inv.jv.vcf").toURI().getPath());
